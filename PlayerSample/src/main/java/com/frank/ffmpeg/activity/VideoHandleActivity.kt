...
import com.woodpecker.qiqivideoplayer.newPlayer.activity.NormalVideoActivity
            ...
            when (msg.what) {
                ...
                MSG_FINISH -> {
                    ...
                    if (!outputPath.isNullOrEmpty() && !this@VideoHandleActivity.isDestroyed) {
                        val intent = Intent()
                        intent.setClass(this@VideoHandleActivity, NormalVideoActivity::class.java)
                        intent.putExtra(ConstantVideo.OUTPUT_PATH, outputPath);
...
//        hideActionBar()
    ...
    companion object {
        ...
        private val PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).path
