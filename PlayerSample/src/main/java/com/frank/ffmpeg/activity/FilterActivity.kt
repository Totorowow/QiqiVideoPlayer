...
class FilterActivity : BaseActivity(), SurfaceHolder.Callback {
    ...
    private var videoPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).path + "/beyond.mp4"
    ...
    private val txtArray = arrayOf(
            QiqiApplication.getInstance().getString(R.string.filter_sketch),
            QiqiApplication.getInstance().getString(R.string.filter_distinct),
            QiqiApplication.getInstance().getString(R.string.filter_edge),
            QiqiApplication.getInstance().getString(R.string.filter_division),
            QiqiApplication.getInstance().getString(R.string.filter_equalize),
            QiqiApplication.getInstance().getString(R.string.filter_rectangle),
            QiqiApplication.getInstance().getString(R.string.filter_flip),
            QiqiApplication.getInstance().getString(R.string.filter_blur),
            QiqiApplication.getInstance().getString(R.string.filter_rotate),
            QiqiApplication.getInstance().getString(R.string.filter_sharpening))
